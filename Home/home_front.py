...
def front(email):
    ...
    criar_label(frame_user, line_dict['role'], 'Calibri, 12',1, 0)
    criar_label(frame_user, line_dict['name'], 'Calibri, 12',2, 0)
