...
def run(frame_parent):
    ...
    for i in range(5):
        ...
        frm_criteria = Frame(frm_avaliacao, relief=GROOVE, bd=3)
    ...
    def computar_resposta(i):
        ...
        if escalas[i].get() <= 3:
            ...
            frm_criteria_feedback = Frame(frm_criteria)
    ...
    def enviar_notas():
        ...
        from Utils.back_avaliacao import criar_dados
        ...
        criar_dados(to_user_id, notas, comentarios)
